...
import static com.lrc.ocr.domain.ocr.model.valobj.OcrErrorVO.HTTP_ERROR;
import static com.lrc.ocr.domain.ocr.model.valobj.OcrErrorVO.URL_ERROR;
...
public abstract class OcrUrlService implements IOcrService{
     ...
     */
    @Override
    public List<ApiDataAggregate> getTotalByUrl(OcrDTO ocrDTO) {
        String reqUrl = ocrDTO.getImgUrl();
        ...
        // 请求响应
        ApiResponseAggregate response = getResponse(ocrDTO);
        // todo 存入数据库
     ...
     * @return Api对象
     */
    protected ApiResponseAggregate getResponse(OcrDTO ocrDTO){
