...
import com.lrc.ocr.domain.ocr.service.OcrFileService;
...
public class OcrServiceImpl extends OcrFileService {
     ...
     */
    @Override
    public OcrTextVO getTextByUrl(OcrDTO ocrDTO) {
        // 请求获取响应对象
        List<ApiDataAggregate> apiDataAggregates = getTotalByUrl(ocrDTO);
        // 获取text
