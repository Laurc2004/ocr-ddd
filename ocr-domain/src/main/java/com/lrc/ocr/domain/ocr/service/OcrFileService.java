...
import static com.lrc.ocr.domain.ocr.model.valobj.OcrErrorVO.FILE_ERROR;
import static com.lrc.ocr.domain.ocr.model.valobj.OcrErrorVO.IMAGE_ERROR;
...
public abstract class OcrFileService extends OcrUrlService {
    ...
    public List<ApiDataAggregate> getToal(MultipartFile file) {
        ...
        ApiResponseAggregate response = getResponse(new OcrDTO(imgUrl));
